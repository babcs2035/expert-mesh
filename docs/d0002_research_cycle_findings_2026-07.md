...
> **【状態: 歴史的記録 — 対象は Iter1〜22】**
> 研究は Iteration 54 で収束した．**収束時点の現況は `docs/d0006_research_summary_iter28-54_2026-08.md`
> を参照すること**．本書 §4「現在の到達点」（top1 0.5651 等）は Iter25 の評価集合拡張（1600 問）と
> Iter26 の fallback 廃止で更新済みである．§8「未解決の論点」のうち，中央集権ルータとの比較は
> Iter26 で実施され，fallback の有害性は Iter28 で対処された．
> §6-B（レバーを読むコードに到達しない no-op 実験）の指摘は現在も有効であり，d0006 §5 に一般化して
> 引き継いでいる．
