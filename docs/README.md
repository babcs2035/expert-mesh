...
3. `d0007` — 収束後，次に何を検討・実験すべきか（**現況．最新の方向性調査**）
4. 必要に応じて `d0004`（Iter15〜27 の詳細）や `d0001`〜`d0003`（初期の経緯）を参照
...
| **`d0007_next_research_directions_2026-08.md`** | **Iter54 収束後** | **2026-08-08** | **現況**．education_recall 改善打ち止め後の次の研究方向性調査．`.claude/research/config.yml` の levers/research_frontier 追加の根拠 |
