...
2. `d0006` — 研究として何が分かったのか（Iter1〜54 の収束時点の総括）
3. `d0007` — 収束後，次に何を検討・実験すべきか（周辺課題の方向性調査）
4. `d0008` — 2026-09-23 の方針転換後，何を検討・実験すべきか（**現況．最新の方向性調査**）
5. 必要に応じて `d0004`（Iter15〜27 の詳細）や `d0001`〜`d0003`（初期の経緯）を参照
...
| `d0006_research_summary_iter28-54_2026-08.md` | Iter28〜54 | 2026-08-05 | 収束時点の総括．§7 に要人間判断の最終確定（2026-08-05）を記載 |
| `d0007_next_research_directions_2026-08.md` | Iter54 収束後 | 2026-08-08 | 有効．education_recall 改善打ち止め後の周辺課題（言語一貫性・複合recall・特化モデル）調査 |
| **`d0008_policy_change_and_next_directions_2026-09.md`** | **2026-09-23 方針転換後** | **2026-09-23** | **現況**．ドメイン固有補正の全廃・人間棄権の完全廃止を受けた，top1_accuracy 全自動向上の次の一手調査．backlog B115 の根拠 |
